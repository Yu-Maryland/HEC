#map = affine_map<(d0) -> (((d0 floordiv 20) floordiv 20) * 400)>
...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @kernel_trisolv(%arg0: i32, %arg1: memref<?x2000xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg4 = 0 to %0 {
      ...
      affine.for %arg5 = 0 to #map(%arg4) step 400 {
        ...
        %2284 = affine.apply #map38(%arg5)
        %2285 = affine.load %arg1[%arg4, %2284] : memref<?x2000xf64>
        %2286 = affine.load %arg2[%2284] : memref<?xf64>
        %2287 = arith.mulf %2285, %2286 : f64
        %2288 = affine.load %arg2[%arg4] : memref<?xf64>
        %2289 = arith.subf %2288, %2287 : f64
        affine.store %2289, %arg2[%arg4] : memref<?xf64>
        %2290 = affine.apply #map1(%2284)
        %2291 = affine.load %arg1[%arg4, %2290] : memref<?x2000xf64>
        %2292 = affine.load %arg2[%2290] : memref<?xf64>
        %2293 = arith.mulf %2291, %2292 : f64
        %2294 = affine.load %arg2[%arg4] : memref<?xf64>
        %2295 = arith.subf %2294, %2293 : f64
        affine.store %2295, %arg2[%arg4] : memref<?xf64>
        %2296 = affine.apply #map2(%2284)
        %2297 = affine.load %arg1[%arg4, %2296] : memref<?x2000xf64>
        %2298 = affine.load %arg2[%2296] : memref<?xf64>
        %2299 = arith.mulf %2297, %2298 : f64
        %2300 = affine.load %arg2[%arg4] : memref<?xf64>
        %2301 = arith.subf %2300, %2299 : f64
        affine.store %2301, %arg2[%arg4] : memref<?xf64>
        %2302 = affine.apply #map3(%2284)
        %2303 = affine.load %arg1[%arg4, %2302] : memref<?x2000xf64>
        %2304 = affine.load %arg2[%2302] : memref<?xf64>
        %2305 = arith.mulf %2303, %2304 : f64
        %2306 = affine.load %arg2[%arg4] : memref<?xf64>
        %2307 = arith.subf %2306, %2305 : f64
        affine.store %2307, %arg2[%arg4] : memref<?xf64>
        %2308 = affine.apply #map4(%2284)
        %2309 = affine.load %arg1[%arg4, %2308] : memref<?x2000xf64>
        %2310 = affine.load %arg2[%2308] : memref<?xf64>
        %2311 = arith.mulf %2309, %2310 : f64
        %2312 = affine.load %arg2[%arg4] : memref<?xf64>
        %2313 = arith.subf %2312, %2311 : f64
        affine.store %2313, %arg2[%arg4] : memref<?xf64>
        %2314 = affine.apply #map5(%2284)
        %2315 = affine.load %arg1[%arg4, %2314] : memref<?x2000xf64>
        %2316 = affine.load %arg2[%2314] : memref<?xf64>
        %2317 = arith.mulf %2315, %2316 : f64
        %2318 = affine.load %arg2[%arg4] : memref<?xf64>
        %2319 = arith.subf %2318, %2317 : f64
        affine.store %2319, %arg2[%arg4] : memref<?xf64>
        %2320 = affine.apply #map6(%2284)
        %2321 = affine.load %arg1[%arg4, %2320] : memref<?x2000xf64>
        %2322 = affine.load %arg2[%2320] : memref<?xf64>
        %2323 = arith.mulf %2321, %2322 : f64
        %2324 = affine.load %arg2[%arg4] : memref<?xf64>
        %2325 = arith.subf %2324, %2323 : f64
        affine.store %2325, %arg2[%arg4] : memref<?xf64>
        %2326 = affine.apply #map7(%2284)
        %2327 = affine.load %arg1[%arg4, %2326] : memref<?x2000xf64>
        %2328 = affine.load %arg2[%2326] : memref<?xf64>
        %2329 = arith.mulf %2327, %2328 : f64
        %2330 = affine.load %arg2[%arg4] : memref<?xf64>
        %2331 = arith.subf %2330, %2329 : f64
        affine.store %2331, %arg2[%arg4] : memref<?xf64>
        %2332 = affine.apply #map8(%2284)
        %2333 = affine.load %arg1[%arg4, %2332] : memref<?x2000xf64>
        %2334 = affine.load %arg2[%2332] : memref<?xf64>
        %2335 = arith.mulf %2333, %2334 : f64
        %2336 = affine.load %arg2[%arg4] : memref<?xf64>
        %2337 = arith.subf %2336, %2335 : f64
        affine.store %2337, %arg2[%arg4] : memref<?xf64>
        %2338 = affine.apply #map9(%2284)
        %2339 = affine.load %arg1[%arg4, %2338] : memref<?x2000xf64>
        %2340 = affine.load %arg2[%2338] : memref<?xf64>
        %2341 = arith.mulf %2339, %2340 : f64
        %2342 = affine.load %arg2[%arg4] : memref<?xf64>
        %2343 = arith.subf %2342, %2341 : f64
        affine.store %2343, %arg2[%arg4] : memref<?xf64>
        %2344 = affine.apply #map10(%2284)
        %2345 = affine.load %arg1[%arg4, %2344] : memref<?x2000xf64>
        %2346 = affine.load %arg2[%2344] : memref<?xf64>
        %2347 = arith.mulf %2345, %2346 : f64
        %2348 = affine.load %arg2[%arg4] : memref<?xf64>
        %2349 = arith.subf %2348, %2347 : f64
        affine.store %2349, %arg2[%arg4] : memref<?xf64>
        %2350 = affine.apply #map11(%2284)
        %2351 = affine.load %arg1[%arg4, %2350] : memref<?x2000xf64>
        %2352 = affine.load %arg2[%2350] : memref<?xf64>
        %2353 = arith.mulf %2351, %2352 : f64
        %2354 = affine.load %arg2[%arg4] : memref<?xf64>
        %2355 = arith.subf %2354, %2353 : f64
        affine.store %2355, %arg2[%arg4] : memref<?xf64>
        %2356 = affine.apply #map12(%2284)
        %2357 = affine.load %arg1[%arg4, %2356] : memref<?x2000xf64>
        %2358 = affine.load %arg2[%2356] : memref<?xf64>
        %2359 = arith.mulf %2357, %2358 : f64
        %2360 = affine.load %arg2[%arg4] : memref<?xf64>
        %2361 = arith.subf %2360, %2359 : f64
        affine.store %2361, %arg2[%arg4] : memref<?xf64>
        %2362 = affine.apply #map13(%2284)
        %2363 = affine.load %arg1[%arg4, %2362] : memref<?x2000xf64>
        %2364 = affine.load %arg2[%2362] : memref<?xf64>
        %2365 = arith.mulf %2363, %2364 : f64
        %2366 = affine.load %arg2[%arg4] : memref<?xf64>
        %2367 = arith.subf %2366, %2365 : f64
        affine.store %2367, %arg2[%arg4] : memref<?xf64>
        %2368 = affine.apply #map14(%2284)
        %2369 = affine.load %arg1[%arg4, %2368] : memref<?x2000xf64>
        %2370 = affine.load %arg2[%2368] : memref<?xf64>
        %2371 = arith.mulf %2369, %2370 : f64
        %2372 = affine.load %arg2[%arg4] : memref<?xf64>
        %2373 = arith.subf %2372, %2371 : f64
        affine.store %2373, %arg2[%arg4] : memref<?xf64>
        %2374 = affine.apply #map15(%2284)
        %2375 = affine.load %arg1[%arg4, %2374] : memref<?x2000xf64>
        %2376 = affine.load %arg2[%2374] : memref<?xf64>
        %2377 = arith.mulf %2375, %2376 : f64
        %2378 = affine.load %arg2[%arg4] : memref<?xf64>
        %2379 = arith.subf %2378, %2377 : f64
        affine.store %2379, %arg2[%arg4] : memref<?xf64>
        %2380 = affine.apply #map16(%2284)
        %2381 = affine.load %arg1[%arg4, %2380] : memref<?x2000xf64>
        %2382 = affine.load %arg2[%2380] : memref<?xf64>
        %2383 = arith.mulf %2381, %2382 : f64
        %2384 = affine.load %arg2[%arg4] : memref<?xf64>
        %2385 = arith.subf %2384, %2383 : f64
        affine.store %2385, %arg2[%arg4] : memref<?xf64>
        %2386 = affine.apply #map17(%2284)
        %2387 = affine.load %arg1[%arg4, %2386] : memref<?x2000xf64>
        %2388 = affine.load %arg2[%2386] : memref<?xf64>
        %2389 = arith.mulf %2387, %2388 : f64
        %2390 = affine.load %arg2[%arg4] : memref<?xf64>
        %2391 = arith.subf %2390, %2389 : f64
        affine.store %2391, %arg2[%arg4] : memref<?xf64>
        %2392 = affine.apply #map18(%2284)
        %2393 = affine.load %arg1[%arg4, %2392] : memref<?x2000xf64>
        %2394 = affine.load %arg2[%2392] : memref<?xf64>
        %2395 = arith.mulf %2393, %2394 : f64
        %2396 = affine.load %arg2[%arg4] : memref<?xf64>
        %2397 = arith.subf %2396, %2395 : f64
        affine.store %2397, %arg2[%arg4] : memref<?xf64>
        %2398 = affine.apply #map19(%2284)
        %2399 = affine.load %arg1[%arg4, %2398] : memref<?x2000xf64>
        %2400 = affine.load %arg2[%2398] : memref<?xf64>
        %2401 = arith.mulf %2399, %2400 : f64
        %2402 = affine.load %arg2[%arg4] : memref<?xf64>
        %2403 = arith.subf %2402, %2401 : f64
        affine.store %2403, %arg2[%arg4] : memref<?xf64>
      }
      affine.for %arg5 = #map(%arg4) to #map39(%arg4) step 20 {
        %5 = affine.load %arg1[%arg4, %arg5] : memref<?x2000xf64>
        %6 = affine.load %arg2[%arg5] : memref<?xf64>
        %7 = arith.mulf %5, %6 : f64
        %8 = affine.load %arg2[%arg4] : memref<?xf64>
      ...
      affine.for %arg5 = #map39(%arg4) to #map39(%arg4) step 20 {
        %5 = affine.load %arg1[%arg4, %arg5] : memref<?x2000xf64>
        %6 = affine.load %arg2[%arg5] : memref<?xf64>
        %7 = arith.mulf %5, %6 : f64
        %8 = affine.load %arg2[%arg4] : memref<?xf64>
