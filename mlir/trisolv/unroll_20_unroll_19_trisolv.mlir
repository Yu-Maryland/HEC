#map = affine_map<(d0) -> (((d0 floordiv 19) floordiv 20) * 380)>
...
#map39 = affine_map<(d0) -> ((d0 floordiv 19) * 19 + ((d0 mod 19) floordiv 20) * 20)>
...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @kernel_trisolv(%arg0: i32, %arg1: memref<?x2000xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg4 = 0 to %0 {
      ...
      affine.for %arg5 = 0 to #map(%arg4) step 380 {
        ...
        %2045 = affine.load %arg1[%arg4, %2044] : memref<?x2000xf64>
        %2046 = affine.load %arg2[%2044] : memref<?xf64>
        %2047 = arith.mulf %2045, %2046 : f64
        %2048 = affine.load %arg2[%arg4] : memref<?xf64>
        %2049 = arith.subf %2048, %2047 : f64
        affine.store %2049, %arg2[%arg4] : memref<?xf64>
        %2050 = affine.apply #map18(%1942)
        %2051 = affine.load %arg1[%arg4, %2050] : memref<?x2000xf64>
        %2052 = affine.load %arg2[%2050] : memref<?xf64>
        %2053 = arith.mulf %2051, %2052 : f64
        %2054 = affine.load %arg2[%arg4] : memref<?xf64>
        %2055 = arith.subf %2054, %2053 : f64
        affine.store %2055, %arg2[%arg4] : memref<?xf64>
        %2056 = affine.apply #map36(%arg5)
        %2057 = affine.load %arg1[%arg4, %2056] : memref<?x2000xf64>
        %2058 = affine.load %arg2[%2056] : memref<?xf64>
        %2059 = arith.mulf %2057, %2058 : f64
        %2060 = affine.load %arg2[%arg4] : memref<?xf64>
        %2061 = arith.subf %2060, %2059 : f64
        affine.store %2061, %arg2[%arg4] : memref<?xf64>
        %2062 = affine.apply #map1(%2056)
        %2063 = affine.load %arg1[%arg4, %2062] : memref<?x2000xf64>
        %2064 = affine.load %arg2[%2062] : memref<?xf64>
        %2065 = arith.mulf %2063, %2064 : f64
        %2066 = affine.load %arg2[%arg4] : memref<?xf64>
        %2067 = arith.subf %2066, %2065 : f64
        affine.store %2067, %arg2[%arg4] : memref<?xf64>
        %2068 = affine.apply #map2(%2056)
        %2069 = affine.load %arg1[%arg4, %2068] : memref<?x2000xf64>
        %2070 = affine.load %arg2[%2068] : memref<?xf64>
        %2071 = arith.mulf %2069, %2070 : f64
        %2072 = affine.load %arg2[%arg4] : memref<?xf64>
        %2073 = arith.subf %2072, %2071 : f64
        affine.store %2073, %arg2[%arg4] : memref<?xf64>
        %2074 = affine.apply #map3(%2056)
        %2075 = affine.load %arg1[%arg4, %2074] : memref<?x2000xf64>
        %2076 = affine.load %arg2[%2074] : memref<?xf64>
        %2077 = arith.mulf %2075, %2076 : f64
        %2078 = affine.load %arg2[%arg4] : memref<?xf64>
        %2079 = arith.subf %2078, %2077 : f64
        affine.store %2079, %arg2[%arg4] : memref<?xf64>
        %2080 = affine.apply #map4(%2056)
        %2081 = affine.load %arg1[%arg4, %2080] : memref<?x2000xf64>
        %2082 = affine.load %arg2[%2080] : memref<?xf64>
        %2083 = arith.mulf %2081, %2082 : f64
        %2084 = affine.load %arg2[%arg4] : memref<?xf64>
        %2085 = arith.subf %2084, %2083 : f64
        affine.store %2085, %arg2[%arg4] : memref<?xf64>
        %2086 = affine.apply #map5(%2056)
        %2087 = affine.load %arg1[%arg4, %2086] : memref<?x2000xf64>
        %2088 = affine.load %arg2[%2086] : memref<?xf64>
        %2089 = arith.mulf %2087, %2088 : f64
        %2090 = affine.load %arg2[%arg4] : memref<?xf64>
        %2091 = arith.subf %2090, %2089 : f64
        affine.store %2091, %arg2[%arg4] : memref<?xf64>
        %2092 = affine.apply #map6(%2056)
        %2093 = affine.load %arg1[%arg4, %2092] : memref<?x2000xf64>
        %2094 = affine.load %arg2[%2092] : memref<?xf64>
        %2095 = arith.mulf %2093, %2094 : f64
        %2096 = affine.load %arg2[%arg4] : memref<?xf64>
        %2097 = arith.subf %2096, %2095 : f64
        affine.store %2097, %arg2[%arg4] : memref<?xf64>
        %2098 = affine.apply #map7(%2056)
        %2099 = affine.load %arg1[%arg4, %2098] : memref<?x2000xf64>
        %2100 = affine.load %arg2[%2098] : memref<?xf64>
        %2101 = arith.mulf %2099, %2100 : f64
        %2102 = affine.load %arg2[%arg4] : memref<?xf64>
        %2103 = arith.subf %2102, %2101 : f64
        affine.store %2103, %arg2[%arg4] : memref<?xf64>
        %2104 = affine.apply #map8(%2056)
        %2105 = affine.load %arg1[%arg4, %2104] : memref<?x2000xf64>
        %2106 = affine.load %arg2[%2104] : memref<?xf64>
        %2107 = arith.mulf %2105, %2106 : f64
        %2108 = affine.load %arg2[%arg4] : memref<?xf64>
        %2109 = arith.subf %2108, %2107 : f64
        affine.store %2109, %arg2[%arg4] : memref<?xf64>
        %2110 = affine.apply #map9(%2056)
        %2111 = affine.load %arg1[%arg4, %2110] : memref<?x2000xf64>
        %2112 = affine.load %arg2[%2110] : memref<?xf64>
        %2113 = arith.mulf %2111, %2112 : f64
        %2114 = affine.load %arg2[%arg4] : memref<?xf64>
        %2115 = arith.subf %2114, %2113 : f64
        affine.store %2115, %arg2[%arg4] : memref<?xf64>
        %2116 = affine.apply #map10(%2056)
        %2117 = affine.load %arg1[%arg4, %2116] : memref<?x2000xf64>
        %2118 = affine.load %arg2[%2116] : memref<?xf64>
        %2119 = arith.mulf %2117, %2118 : f64
        %2120 = affine.load %arg2[%arg4] : memref<?xf64>
        %2121 = arith.subf %2120, %2119 : f64
        affine.store %2121, %arg2[%arg4] : memref<?xf64>
        %2122 = affine.apply #map11(%2056)
        %2123 = affine.load %arg1[%arg4, %2122] : memref<?x2000xf64>
        %2124 = affine.load %arg2[%2122] : memref<?xf64>
        %2125 = arith.mulf %2123, %2124 : f64
        %2126 = affine.load %arg2[%arg4] : memref<?xf64>
        %2127 = arith.subf %2126, %2125 : f64
        affine.store %2127, %arg2[%arg4] : memref<?xf64>
        %2128 = affine.apply #map12(%2056)
        %2129 = affine.load %arg1[%arg4, %2128] : memref<?x2000xf64>
        %2130 = affine.load %arg2[%2128] : memref<?xf64>
        %2131 = arith.mulf %2129, %2130 : f64
        %2132 = affine.load %arg2[%arg4] : memref<?xf64>
        %2133 = arith.subf %2132, %2131 : f64
        affine.store %2133, %arg2[%arg4] : memref<?xf64>
        %2134 = affine.apply #map13(%2056)
        %2135 = affine.load %arg1[%arg4, %2134] : memref<?x2000xf64>
        %2136 = affine.load %arg2[%2134] : memref<?xf64>
        %2137 = arith.mulf %2135, %2136 : f64
        %2138 = affine.load %arg2[%arg4] : memref<?xf64>
        %2139 = arith.subf %2138, %2137 : f64
        affine.store %2139, %arg2[%arg4] : memref<?xf64>
        %2140 = affine.apply #map14(%2056)
        %2141 = affine.load %arg1[%arg4, %2140] : memref<?x2000xf64>
        %2142 = affine.load %arg2[%2140] : memref<?xf64>
        %2143 = arith.mulf %2141, %2142 : f64
        %2144 = affine.load %arg2[%arg4] : memref<?xf64>
        %2145 = arith.subf %2144, %2143 : f64
        affine.store %2145, %arg2[%arg4] : memref<?xf64>
        %2146 = affine.apply #map15(%2056)
        %2147 = affine.load %arg1[%arg4, %2146] : memref<?x2000xf64>
        %2148 = affine.load %arg2[%2146] : memref<?xf64>
        %2149 = arith.mulf %2147, %2148 : f64
        %2150 = affine.load %arg2[%arg4] : memref<?xf64>
        %2151 = arith.subf %2150, %2149 : f64
        affine.store %2151, %arg2[%arg4] : memref<?xf64>
        %2152 = affine.apply #map16(%2056)
        %2153 = affine.load %arg1[%arg4, %2152] : memref<?x2000xf64>
        %2154 = affine.load %arg2[%2152] : memref<?xf64>
        %2155 = arith.mulf %2153, %2154 : f64
        %2156 = affine.load %arg2[%arg4] : memref<?xf64>
        %2157 = arith.subf %2156, %2155 : f64
        affine.store %2157, %arg2[%arg4] : memref<?xf64>
        %2158 = affine.apply #map17(%2056)
        %2159 = affine.load %arg1[%arg4, %2158] : memref<?x2000xf64>
        %2160 = affine.load %arg2[%2158] : memref<?xf64>
        %2161 = arith.mulf %2159, %2160 : f64
        %2162 = affine.load %arg2[%arg4] : memref<?xf64>
        %2163 = arith.subf %2162, %2161 : f64
        affine.store %2163, %arg2[%arg4] : memref<?xf64>
        %2164 = affine.apply #map18(%2056)
        %2165 = affine.load %arg1[%arg4, %2164] : memref<?x2000xf64>
        %2166 = affine.load %arg2[%2164] : memref<?xf64>
        %2167 = arith.mulf %2165, %2166 : f64
        %2168 = affine.load %arg2[%arg4] : memref<?xf64>
        %2169 = arith.subf %2168, %2167 : f64
        affine.store %2169, %arg2[%arg4] : memref<?xf64>
        %2170 = affine.apply #map37(%arg5)
        %2171 = affine.load %arg1[%arg4, %2170] : memref<?x2000xf64>
        %2172 = affine.load %arg2[%2170] : memref<?xf64>
        %2173 = arith.mulf %2171, %2172 : f64
        %2174 = affine.load %arg2[%arg4] : memref<?xf64>
        %2175 = arith.subf %2174, %2173 : f64
        affine.store %2175, %arg2[%arg4] : memref<?xf64>
        %2176 = affine.apply #map1(%2170)
        %2177 = affine.load %arg1[%arg4, %2176] : memref<?x2000xf64>
        %2178 = affine.load %arg2[%2176] : memref<?xf64>
        %2179 = arith.mulf %2177, %2178 : f64
        %2180 = affine.load %arg2[%arg4] : memref<?xf64>
        %2181 = arith.subf %2180, %2179 : f64
        affine.store %2181, %arg2[%arg4] : memref<?xf64>
        %2182 = affine.apply #map2(%2170)
        %2183 = affine.load %arg1[%arg4, %2182] : memref<?x2000xf64>
        %2184 = affine.load %arg2[%2182] : memref<?xf64>
        %2185 = arith.mulf %2183, %2184 : f64
        %2186 = affine.load %arg2[%arg4] : memref<?xf64>
        %2187 = arith.subf %2186, %2185 : f64
        affine.store %2187, %arg2[%arg4] : memref<?xf64>
        %2188 = affine.apply #map3(%2170)
        %2189 = affine.load %arg1[%arg4, %2188] : memref<?x2000xf64>
        %2190 = affine.load %arg2[%2188] : memref<?xf64>
        %2191 = arith.mulf %2189, %2190 : f64
        %2192 = affine.load %arg2[%arg4] : memref<?xf64>
        %2193 = arith.subf %2192, %2191 : f64
        affine.store %2193, %arg2[%arg4] : memref<?xf64>
        %2194 = affine.apply #map4(%2170)
        %2195 = affine.load %arg1[%arg4, %2194] : memref<?x2000xf64>
        %2196 = affine.load %arg2[%2194] : memref<?xf64>
        %2197 = arith.mulf %2195, %2196 : f64
        %2198 = affine.load %arg2[%arg4] : memref<?xf64>
        %2199 = arith.subf %2198, %2197 : f64
        affine.store %2199, %arg2[%arg4] : memref<?xf64>
        %2200 = affine.apply #map5(%2170)
        %2201 = affine.load %arg1[%arg4, %2200] : memref<?x2000xf64>
        %2202 = affine.load %arg2[%2200] : memref<?xf64>
        %2203 = arith.mulf %2201, %2202 : f64
        %2204 = affine.load %arg2[%arg4] : memref<?xf64>
        %2205 = arith.subf %2204, %2203 : f64
        affine.store %2205, %arg2[%arg4] : memref<?xf64>
        %2206 = affine.apply #map6(%2170)
        %2207 = affine.load %arg1[%arg4, %2206] : memref<?x2000xf64>
        %2208 = affine.load %arg2[%2206] : memref<?xf64>
        %2209 = arith.mulf %2207, %2208 : f64
        %2210 = affine.load %arg2[%arg4] : memref<?xf64>
        %2211 = arith.subf %2210, %2209 : f64
        affine.store %2211, %arg2[%arg4] : memref<?xf64>
        %2212 = affine.apply #map7(%2170)
        %2213 = affine.load %arg1[%arg4, %2212] : memref<?x2000xf64>
        %2214 = affine.load %arg2[%2212] : memref<?xf64>
        %2215 = arith.mulf %2213, %2214 : f64
        %2216 = affine.load %arg2[%arg4] : memref<?xf64>
        %2217 = arith.subf %2216, %2215 : f64
        affine.store %2217, %arg2[%arg4] : memref<?xf64>
        %2218 = affine.apply #map8(%2170)
        %2219 = affine.load %arg1[%arg4, %2218] : memref<?x2000xf64>
        %2220 = affine.load %arg2[%2218] : memref<?xf64>
        %2221 = arith.mulf %2219, %2220 : f64
        %2222 = affine.load %arg2[%arg4] : memref<?xf64>
        %2223 = arith.subf %2222, %2221 : f64
        affine.store %2223, %arg2[%arg4] : memref<?xf64>
        %2224 = affine.apply #map9(%2170)
        %2225 = affine.load %arg1[%arg4, %2224] : memref<?x2000xf64>
        %2226 = affine.load %arg2[%2224] : memref<?xf64>
        %2227 = arith.mulf %2225, %2226 : f64
        %2228 = affine.load %arg2[%arg4] : memref<?xf64>
        %2229 = arith.subf %2228, %2227 : f64
        affine.store %2229, %arg2[%arg4] : memref<?xf64>
        %2230 = affine.apply #map10(%2170)
        %2231 = affine.load %arg1[%arg4, %2230] : memref<?x2000xf64>
        %2232 = affine.load %arg2[%2230] : memref<?xf64>
        %2233 = arith.mulf %2231, %2232 : f64
        %2234 = affine.load %arg2[%arg4] : memref<?xf64>
        %2235 = arith.subf %2234, %2233 : f64
        affine.store %2235, %arg2[%arg4] : memref<?xf64>
        %2236 = affine.apply #map11(%2170)
        %2237 = affine.load %arg1[%arg4, %2236] : memref<?x2000xf64>
        %2238 = affine.load %arg2[%2236] : memref<?xf64>
        %2239 = arith.mulf %2237, %2238 : f64
        %2240 = affine.load %arg2[%arg4] : memref<?xf64>
        %2241 = arith.subf %2240, %2239 : f64
        affine.store %2241, %arg2[%arg4] : memref<?xf64>
        %2242 = affine.apply #map12(%2170)
        %2243 = affine.load %arg1[%arg4, %2242] : memref<?x2000xf64>
        %2244 = affine.load %arg2[%2242] : memref<?xf64>
        %2245 = arith.mulf %2243, %2244 : f64
        %2246 = affine.load %arg2[%arg4] : memref<?xf64>
        %2247 = arith.subf %2246, %2245 : f64
        affine.store %2247, %arg2[%arg4] : memref<?xf64>
        %2248 = affine.apply #map13(%2170)
        %2249 = affine.load %arg1[%arg4, %2248] : memref<?x2000xf64>
        %2250 = affine.load %arg2[%2248] : memref<?xf64>
        %2251 = arith.mulf %2249, %2250 : f64
        %2252 = affine.load %arg2[%arg4] : memref<?xf64>
        %2253 = arith.subf %2252, %2251 : f64
        affine.store %2253, %arg2[%arg4] : memref<?xf64>
        %2254 = affine.apply #map14(%2170)
        %2255 = affine.load %arg1[%arg4, %2254] : memref<?x2000xf64>
        %2256 = affine.load %arg2[%2254] : memref<?xf64>
        %2257 = arith.mulf %2255, %2256 : f64
        %2258 = affine.load %arg2[%arg4] : memref<?xf64>
        %2259 = arith.subf %2258, %2257 : f64
        affine.store %2259, %arg2[%arg4] : memref<?xf64>
        %2260 = affine.apply #map15(%2170)
        %2261 = affine.load %arg1[%arg4, %2260] : memref<?x2000xf64>
        %2262 = affine.load %arg2[%2260] : memref<?xf64>
        %2263 = arith.mulf %2261, %2262 : f64
        %2264 = affine.load %arg2[%arg4] : memref<?xf64>
        %2265 = arith.subf %2264, %2263 : f64
        affine.store %2265, %arg2[%arg4] : memref<?xf64>
        %2266 = affine.apply #map16(%2170)
        %2267 = affine.load %arg1[%arg4, %2266] : memref<?x2000xf64>
        %2268 = affine.load %arg2[%2266] : memref<?xf64>
        %2269 = arith.mulf %2267, %2268 : f64
        %2270 = affine.load %arg2[%arg4] : memref<?xf64>
        %2271 = arith.subf %2270, %2269 : f64
        affine.store %2271, %arg2[%arg4] : memref<?xf64>
        %2272 = affine.apply #map17(%2170)
        %2273 = affine.load %arg1[%arg4, %2272] : memref<?x2000xf64>
        %2274 = affine.load %arg2[%2272] : memref<?xf64>
        %2275 = arith.mulf %2273, %2274 : f64
        %2276 = affine.load %arg2[%arg4] : memref<?xf64>
        %2277 = arith.subf %2276, %2275 : f64
        affine.store %2277, %arg2[%arg4] : memref<?xf64>
        %2278 = affine.apply #map18(%2170)
        %2279 = affine.load %arg1[%arg4, %2278] : memref<?x2000xf64>
        %2280 = affine.load %arg2[%2278] : memref<?xf64>
        %2281 = arith.mulf %2279, %2280 : f64
        %2282 = affine.load %arg2[%arg4] : memref<?xf64>
        %2283 = arith.subf %2282, %2281 : f64
        affine.store %2283, %arg2[%arg4] : memref<?xf64>
      }
      affine.for %arg5 = #map(%arg4) to #map38(%arg4) step 19 {
        %5 = affine.load %arg1[%arg4, %arg5] : memref<?x2000xf64>
        %6 = affine.load %arg2[%arg5] : memref<?xf64>
        %7 = arith.mulf %5, %6 : f64
        %8 = affine.load %arg2[%arg4] : memref<?xf64>
      ...
      affine.for %arg5 = #map38(%arg4) to #map39(%arg4) step 20 {
        %5 = affine.load %arg1[%arg4, %arg5] : memref<?x2000xf64>
        %6 = affine.load %arg2[%arg5] : memref<?xf64>
        %7 = arith.mulf %5, %6 : f64
        %8 = affine.load %arg2[%arg4] : memref<?xf64>
      ...
      affine.for %arg5 = #map39(%arg4) to #map40(%arg4) {
        %5 = affine.load %arg1[%arg4, %arg5] : memref<?x2000xf64>
        %6 = affine.load %arg2[%arg5] : memref<?xf64>
        %7 = arith.mulf %5, %6 : f64
        %8 = affine.load %arg2[%arg4] : memref<?xf64>
