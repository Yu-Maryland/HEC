  ...
  func.func @kernel_trisolv(%arg0: i32, %arg1: memref<?x2000xf64>, %arg2: memref<?xf64>, %arg3: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg4 = 0 to %0 step 70 {
      affine.for %arg5 = #map(%arg4) to min #map1(%arg4)[%0] {
        ...
        affine.for %arg6 = 0 to #map2(%arg5) step 256 {
          ...
          %1444 = affine.apply #map32(%arg6)
          %1445 = affine.load %arg1[%arg5, %1444] : memref<?x2000xf64>
          %1446 = affine.load %arg2[%1444] : memref<?xf64>
          %1447 = arith.mulf %1445, %1446 : f64
          %1448 = affine.load %arg2[%arg5] : memref<?xf64>
          %1449 = arith.subf %1448, %1447 : f64
          affine.store %1449, %arg2[%arg5] : memref<?xf64>
          %1450 = affine.apply #map3(%1444)
          %1451 = affine.load %arg1[%arg5, %1450] : memref<?x2000xf64>
          %1452 = affine.load %arg2[%1450] : memref<?xf64>
          %1453 = arith.mulf %1451, %1452 : f64
          %1454 = affine.load %arg2[%arg5] : memref<?xf64>
          %1455 = arith.subf %1454, %1453 : f64
          affine.store %1455, %arg2[%arg5] : memref<?xf64>
          %1456 = affine.apply #map4(%1444)
          %1457 = affine.load %arg1[%arg5, %1456] : memref<?x2000xf64>
          %1458 = affine.load %arg2[%1456] : memref<?xf64>
          %1459 = arith.mulf %1457, %1458 : f64
          %1460 = affine.load %arg2[%arg5] : memref<?xf64>
          %1461 = arith.subf %1460, %1459 : f64
          affine.store %1461, %arg2[%arg5] : memref<?xf64>
          %1462 = affine.apply #map5(%1444)
          %1463 = affine.load %arg1[%arg5, %1462] : memref<?x2000xf64>
          %1464 = affine.load %arg2[%1462] : memref<?xf64>
          %1465 = arith.mulf %1463, %1464 : f64
          %1466 = affine.load %arg2[%arg5] : memref<?xf64>
          %1467 = arith.subf %1466, %1465 : f64
          affine.store %1467, %arg2[%arg5] : memref<?xf64>
          %1468 = affine.apply #map6(%1444)
          %1469 = affine.load %arg1[%arg5, %1468] : memref<?x2000xf64>
          %1470 = affine.load %arg2[%1468] : memref<?xf64>
          %1471 = arith.mulf %1469, %1470 : f64
          %1472 = affine.load %arg2[%arg5] : memref<?xf64>
          %1473 = arith.subf %1472, %1471 : f64
          affine.store %1473, %arg2[%arg5] : memref<?xf64>
          %1474 = affine.apply #map7(%1444)
          %1475 = affine.load %arg1[%arg5, %1474] : memref<?x2000xf64>
          %1476 = affine.load %arg2[%1474] : memref<?xf64>
          %1477 = arith.mulf %1475, %1476 : f64
          %1478 = affine.load %arg2[%arg5] : memref<?xf64>
          %1479 = arith.subf %1478, %1477 : f64
          affine.store %1479, %arg2[%arg5] : memref<?xf64>
          %1480 = affine.apply #map8(%1444)
          %1481 = affine.load %arg1[%arg5, %1480] : memref<?x2000xf64>
          %1482 = affine.load %arg2[%1480] : memref<?xf64>
          %1483 = arith.mulf %1481, %1482 : f64
          %1484 = affine.load %arg2[%arg5] : memref<?xf64>
          %1485 = arith.subf %1484, %1483 : f64
          affine.store %1485, %arg2[%arg5] : memref<?xf64>
          %1486 = affine.apply #map9(%1444)
          %1487 = affine.load %arg1[%arg5, %1486] : memref<?x2000xf64>
          %1488 = affine.load %arg2[%1486] : memref<?xf64>
          %1489 = arith.mulf %1487, %1488 : f64
          %1490 = affine.load %arg2[%arg5] : memref<?xf64>
          %1491 = arith.subf %1490, %1489 : f64
          affine.store %1491, %arg2[%arg5] : memref<?xf64>
          %1492 = affine.apply #map10(%1444)
          %1493 = affine.load %arg1[%arg5, %1492] : memref<?x2000xf64>
          %1494 = affine.load %arg2[%1492] : memref<?xf64>
          %1495 = arith.mulf %1493, %1494 : f64
          %1496 = affine.load %arg2[%arg5] : memref<?xf64>
          %1497 = arith.subf %1496, %1495 : f64
          affine.store %1497, %arg2[%arg5] : memref<?xf64>
          %1498 = affine.apply #map11(%1444)
          %1499 = affine.load %arg1[%arg5, %1498] : memref<?x2000xf64>
          %1500 = affine.load %arg2[%1498] : memref<?xf64>
          %1501 = arith.mulf %1499, %1500 : f64
          %1502 = affine.load %arg2[%arg5] : memref<?xf64>
          %1503 = arith.subf %1502, %1501 : f64
          affine.store %1503, %arg2[%arg5] : memref<?xf64>
          %1504 = affine.apply #map12(%1444)
          %1505 = affine.load %arg1[%arg5, %1504] : memref<?x2000xf64>
          %1506 = affine.load %arg2[%1504] : memref<?xf64>
          %1507 = arith.mulf %1505, %1506 : f64
          %1508 = affine.load %arg2[%arg5] : memref<?xf64>
          %1509 = arith.subf %1508, %1507 : f64
          affine.store %1509, %arg2[%arg5] : memref<?xf64>
          %1510 = affine.apply #map13(%1444)
          %1511 = affine.load %arg1[%arg5, %1510] : memref<?x2000xf64>
          %1512 = affine.load %arg2[%1510] : memref<?xf64>
          %1513 = arith.mulf %1511, %1512 : f64
          %1514 = affine.load %arg2[%arg5] : memref<?xf64>
          %1515 = arith.subf %1514, %1513 : f64
          affine.store %1515, %arg2[%arg5] : memref<?xf64>
          %1516 = affine.apply #map14(%1444)
          %1517 = affine.load %arg1[%arg5, %1516] : memref<?x2000xf64>
          %1518 = affine.load %arg2[%1516] : memref<?xf64>
          %1519 = arith.mulf %1517, %1518 : f64
          %1520 = affine.load %arg2[%arg5] : memref<?xf64>
          %1521 = arith.subf %1520, %1519 : f64
          affine.store %1521, %arg2[%arg5] : memref<?xf64>
          %1522 = affine.apply #map15(%1444)
          %1523 = affine.load %arg1[%arg5, %1522] : memref<?x2000xf64>
          %1524 = affine.load %arg2[%1522] : memref<?xf64>
          %1525 = arith.mulf %1523, %1524 : f64
          %1526 = affine.load %arg2[%arg5] : memref<?xf64>
          %1527 = arith.subf %1526, %1525 : f64
          affine.store %1527, %arg2[%arg5] : memref<?xf64>
          %1528 = affine.apply #map16(%1444)
          %1529 = affine.load %arg1[%arg5, %1528] : memref<?x2000xf64>
          %1530 = affine.load %arg2[%1528] : memref<?xf64>
          %1531 = arith.mulf %1529, %1530 : f64
          %1532 = affine.load %arg2[%arg5] : memref<?xf64>
          %1533 = arith.subf %1532, %1531 : f64
          affine.store %1533, %arg2[%arg5] : memref<?xf64>
          %1534 = affine.apply #map17(%1444)
          %1535 = affine.load %arg1[%arg5, %1534] : memref<?x2000xf64>
          %1536 = affine.load %arg2[%1534] : memref<?xf64>
          %1537 = arith.mulf %1535, %1536 : f64
          %1538 = affine.load %arg2[%arg5] : memref<?xf64>
          %1539 = arith.subf %1538, %1537 : f64
          affine.store %1539, %arg2[%arg5] : memref<?xf64>
        }
        affine.for %arg6 = #map2(%arg5) to #map33(%arg5) step 16 {
          %5 = affine.load %arg1[%arg5, %arg6] : memref<?x2000xf64>
          %6 = affine.load %arg2[%arg6] : memref<?xf64>
          %7 = arith.mulf %5, %6 : f64
          %8 = affine.load %arg2[%arg5] : memref<?xf64>
        ...
        affine.for %arg6 = #map33(%arg5) to #map33(%arg5) step 16 {
          %5 = affine.load %arg1[%arg5, %arg6] : memref<?x2000xf64>
          %6 = affine.load %arg2[%arg6] : memref<?xf64>
          %7 = arith.mulf %5, %6 : f64
          %8 = affine.load %arg2[%arg5] : memref<?xf64>
