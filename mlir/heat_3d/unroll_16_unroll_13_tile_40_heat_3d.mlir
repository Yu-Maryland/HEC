...
#map3 = affine_map<()[s0] -> ((((s0 - 2) floordiv 13) floordiv 16) * 208 + 1)>
...
#map17 = affine_map<(d0) -> (d0 + 26)>
#map18 = affine_map<(d0) -> (d0 + 39)>
#map19 = affine_map<(d0) -> (d0 + 52)>
#map20 = affine_map<(d0) -> (d0 + 65)>
#map21 = affine_map<(d0) -> (d0 + 78)>
#map22 = affine_map<(d0) -> (d0 + 91)>
#map23 = affine_map<(d0) -> (d0 + 104)>
#map24 = affine_map<(d0) -> (d0 + 117)>
#map25 = affine_map<(d0) -> (d0 + 130)>
#map26 = affine_map<(d0) -> (d0 + 143)>
#map27 = affine_map<(d0) -> (d0 + 156)>
#map28 = affine_map<(d0) -> (d0 + 169)>
#map29 = affine_map<(d0) -> (d0 + 182)>
#map30 = affine_map<(d0) -> (d0 + 195)>
#map31 = affine_map<()[s0] -> (((s0 - 2) floordiv 13) * 13 + 1)>
#map32 = affine_map<()[s0] -> (((s0 - 2) floordiv 13) * 13 + ((s0 - ((s0 - 2) floordiv 13) * 13 - 2) floordiv 16) * 16 + 1)>
      ...
      affine.for %arg5 = #map(%arg4) to min #map1(%arg4) {
        affine.for %arg6 = 1 to #map2()[%0] {
          affine.for %arg7 = 1 to #map2()[%0] {
            affine.for %arg8 = 1 to #map3()[%0] step 208 {
            ...
            affine.for %arg8 = #map3()[%0] to #map31()[%0] step 13 {
              %1 = affine.load %arg2[%arg6 + 1, %arg7, %arg8] : memref<?x120x120xf64>
              %2 = affine.load %arg2[%arg6, %arg7, %arg8] : memref<?x120x120xf64>
              %3 = arith.mulf %2, %cst_0 : f64
              %4 = arith.subf %1, %3 : f64
