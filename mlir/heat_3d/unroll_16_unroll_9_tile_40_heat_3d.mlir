...
#map3 = affine_map<()[s0] -> ((((s0 - 2) floordiv 9) floordiv 16) * 144 + 1)>
...
#map14 = affine_map<(d0) -> (d0 + 27)>
#map15 = affine_map<(d0) -> (d0 + 36)>
#map16 = affine_map<(d0) -> (d0 + 45)>
#map17 = affine_map<(d0) -> (d0 + 54)>
#map18 = affine_map<(d0) -> (d0 + 63)>
#map19 = affine_map<(d0) -> (d0 + 72)>
#map20 = affine_map<(d0) -> (d0 + 81)>
...
#map28 = affine_map<()[s0] -> (((s0 - 2) floordiv 9) * 9 + ((s0 - ((s0 - 2) floordiv 9) * 9 - 2) floordiv 16) * 16 + 1)>
      ...
      affine.for %arg5 = #map(%arg4) to min #map1(%arg4) {
        affine.for %arg6 = 1 to #map2()[%0] {
          affine.for %arg7 = 1 to #map2()[%0] {
            affine.for %arg8 = 1 to #map3()[%0] step 144 {
            ...
            affine.for %arg8 = #map3()[%0] to #map27()[%0] step 9 {
              %1 = affine.load %arg2[%arg6 + 1, %arg7, %arg8] : memref<?x120x120xf64>
              %2 = affine.load %arg2[%arg6, %arg7, %arg8] : memref<?x120x120xf64>
              %3 = arith.mulf %2, %cst_0 : f64
              %4 = arith.subf %1, %3 : f64
