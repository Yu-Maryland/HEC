...
#map3 = affine_map<()[s0] -> ((((s0 - 2) floordiv 5) floordiv 10) * 50 + 1)>
...
#map18 = affine_map<()[s0] -> (((s0 - 2) floordiv 5) * 5 + ((s0 - ((s0 - 2) floordiv 5) * 5 - 2) floordiv 10) * 10 + 1)>
      ...
      affine.for %arg5 = #map(%arg4) to min #map1(%arg4) {
        affine.for %arg6 = 1 to #map2()[%0] {
          affine.for %arg7 = 1 to #map2()[%0] {
            affine.for %arg8 = 1 to #map3()[%0] step 50 {
