...
#map1 = affine_map<()[s0] -> ((((s0 - 2) floordiv 14) floordiv 14) * 196 + 1)>
...
#map29 = affine_map<()[s0] -> (((s0 - 2) floordiv 14) * 14 + ((s0 - ((s0 - 2) floordiv 14) * 14 - 2) floordiv 14) * 14 + 1)>
    ...
    affine.for %arg4 = 1 to 501 {
      affine.for %arg5 = 1 to #map()[%0] {
        affine.for %arg6 = 1 to #map()[%0] {
          affine.for %arg7 = 1 to #map1()[%0] step 196 {
          ...
          affine.for %arg7 = #map1()[%0] to #map28()[%0] step 14 {
            %1 = affine.load %arg2[%arg5 + 1, %arg6, %arg7] : memref<?x120x120xf64>
            %2 = affine.load %arg2[%arg5, %arg6, %arg7] : memref<?x120x120xf64>
            %3 = arith.mulf %2, %cst_0 : f64
            %4 = arith.subf %1, %3 : f64
          ...
          affine.for %arg7 = #map29()[%0] to #map()[%0] {
            %1 = affine.load %arg2[%arg5 + 1, %arg6, %arg7] : memref<?x120x120xf64>
            %2 = affine.load %arg2[%arg5, %arg6, %arg7] : memref<?x120x120xf64>
            %3 = arith.mulf %2, %cst_0 : f64
            %4 = arith.subf %1, %3 : f64
