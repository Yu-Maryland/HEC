...
#map3 = affine_map<()[s0] -> ((((s0 - 2) floordiv 11) floordiv 16) * 176 + 1)>
...
#map15 = affine_map<(d0) -> (d0 + 22)>
#map16 = affine_map<(d0) -> (d0 + 33)>
#map17 = affine_map<(d0) -> (d0 + 44)>
#map18 = affine_map<(d0) -> (d0 + 55)>
#map19 = affine_map<(d0) -> (d0 + 66)>
#map20 = affine_map<(d0) -> (d0 + 77)>
#map21 = affine_map<(d0) -> (d0 + 88)>
#map22 = affine_map<(d0) -> (d0 + 99)>
#map23 = affine_map<(d0) -> (d0 + 110)>
#map24 = affine_map<(d0) -> (d0 + 121)>
...
#map30 = affine_map<()[s0] -> (((s0 - 2) floordiv 11) * 11 + ((s0 - ((s0 - 2) floordiv 11) * 11 - 2) floordiv 16) * 16 + 1)>
      ...
      affine.for %arg5 = #map(%arg4) to min #map1(%arg4) {
        affine.for %arg6 = 1 to #map2()[%0] {
          affine.for %arg7 = 1 to #map2()[%0] {
            affine.for %arg8 = 1 to #map3()[%0] step 176 {
            ...
            affine.for %arg8 = #map3()[%0] to #map29()[%0] step 11 {
              %1 = affine.load %arg2[%arg6 + 1, %arg7, %arg8] : memref<?x120x120xf64>
              %2 = affine.load %arg2[%arg6, %arg7, %arg8] : memref<?x120x120xf64>
              %3 = arith.mulf %2, %cst_0 : f64
              %4 = arith.subf %1, %3 : f64
