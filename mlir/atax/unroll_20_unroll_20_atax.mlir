...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @kernel_atax(%arg0: i32, %arg1: i32, %arg2: memref<?x2100xf64>, %arg3: memref<?xf64>, %arg4: memref<?xf64>, %arg5: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg6 = 0 to #map()[%0] step 400 {
      ...
      %381 = affine.apply #map38(%arg6)
      affine.store %cst, %arg4[%381] : memref<?xf64>
      %382 = affine.apply #map1(%381)
      affine.store %cst, %arg4[%382] : memref<?xf64>
      %383 = affine.apply #map2(%381)
      affine.store %cst, %arg4[%383] : memref<?xf64>
      %384 = affine.apply #map3(%381)
      affine.store %cst, %arg4[%384] : memref<?xf64>
      %385 = affine.apply #map4(%381)
      affine.store %cst, %arg4[%385] : memref<?xf64>
      %386 = affine.apply #map5(%381)
      affine.store %cst, %arg4[%386] : memref<?xf64>
      %387 = affine.apply #map6(%381)
      affine.store %cst, %arg4[%387] : memref<?xf64>
      %388 = affine.apply #map7(%381)
      affine.store %cst, %arg4[%388] : memref<?xf64>
      %389 = affine.apply #map8(%381)
      affine.store %cst, %arg4[%389] : memref<?xf64>
      %390 = affine.apply #map9(%381)
      affine.store %cst, %arg4[%390] : memref<?xf64>
      %391 = affine.apply #map10(%381)
      affine.store %cst, %arg4[%391] : memref<?xf64>
      %392 = affine.apply #map11(%381)
      affine.store %cst, %arg4[%392] : memref<?xf64>
      %393 = affine.apply #map12(%381)
      affine.store %cst, %arg4[%393] : memref<?xf64>
      %394 = affine.apply #map13(%381)
      affine.store %cst, %arg4[%394] : memref<?xf64>
      %395 = affine.apply #map14(%381)
      affine.store %cst, %arg4[%395] : memref<?xf64>
      %396 = affine.apply #map15(%381)
      affine.store %cst, %arg4[%396] : memref<?xf64>
      %397 = affine.apply #map16(%381)
      affine.store %cst, %arg4[%397] : memref<?xf64>
      %398 = affine.apply #map17(%381)
      affine.store %cst, %arg4[%398] : memref<?xf64>
      %399 = affine.apply #map18(%381)
      affine.store %cst, %arg4[%399] : memref<?xf64>
      %400 = affine.apply #map19(%381)
      affine.store %cst, %arg4[%400] : memref<?xf64>
    }
    affine.for %arg6 = #map()[%0] to #map39()[%0] step 20 {
      affine.store %cst, %arg4[%arg6] : memref<?xf64>
      %2 = affine.apply #map1(%arg6)
      affine.store %cst, %arg4[%2] : memref<?xf64>
      %3 = affine.apply #map2(%arg6)
    ...
    affine.for %arg6 = #map39()[%0] to #map39()[%0] step 20 {
      affine.store %cst, %arg4[%arg6] : memref<?xf64>
      %2 = affine.apply #map1(%arg6)
      affine.store %cst, %arg4[%2] : memref<?xf64>
      %3 = affine.apply #map2(%arg6)
    ...
    affine.for %arg6 = 0 to %1 {
      ...
      affine.for %arg7 = 0 to #map()[%0] step 400 {
        ...
        %2281 = affine.apply #map38(%arg7)
        %2282 = affine.load %arg5[%arg6] : memref<?xf64>
        %2283 = affine.load %arg2[%arg6, %2281] : memref<?x2100xf64>
        %2284 = affine.load %arg3[%2281] : memref<?xf64>
        %2285 = arith.mulf %2283, %2284 : f64
        %2286 = arith.addf %2282, %2285 : f64
        affine.store %2286, %arg5[%arg6] : memref<?xf64>
        %2287 = affine.apply #map1(%2281)
        %2288 = affine.load %arg5[%arg6] : memref<?xf64>
        %2289 = affine.load %arg2[%arg6, %2287] : memref<?x2100xf64>
        %2290 = affine.load %arg3[%2287] : memref<?xf64>
        %2291 = arith.mulf %2289, %2290 : f64
        %2292 = arith.addf %2288, %2291 : f64
        affine.store %2292, %arg5[%arg6] : memref<?xf64>
        %2293 = affine.apply #map2(%2281)
        %2294 = affine.load %arg5[%arg6] : memref<?xf64>
        %2295 = affine.load %arg2[%arg6, %2293] : memref<?x2100xf64>
        %2296 = affine.load %arg3[%2293] : memref<?xf64>
        %2297 = arith.mulf %2295, %2296 : f64
        %2298 = arith.addf %2294, %2297 : f64
        affine.store %2298, %arg5[%arg6] : memref<?xf64>
        %2299 = affine.apply #map3(%2281)
        %2300 = affine.load %arg5[%arg6] : memref<?xf64>
        %2301 = affine.load %arg2[%arg6, %2299] : memref<?x2100xf64>
        %2302 = affine.load %arg3[%2299] : memref<?xf64>
        %2303 = arith.mulf %2301, %2302 : f64
        %2304 = arith.addf %2300, %2303 : f64
        affine.store %2304, %arg5[%arg6] : memref<?xf64>
        %2305 = affine.apply #map4(%2281)
        %2306 = affine.load %arg5[%arg6] : memref<?xf64>
        %2307 = affine.load %arg2[%arg6, %2305] : memref<?x2100xf64>
        %2308 = affine.load %arg3[%2305] : memref<?xf64>
        %2309 = arith.mulf %2307, %2308 : f64
        %2310 = arith.addf %2306, %2309 : f64
        affine.store %2310, %arg5[%arg6] : memref<?xf64>
        %2311 = affine.apply #map5(%2281)
        %2312 = affine.load %arg5[%arg6] : memref<?xf64>
        %2313 = affine.load %arg2[%arg6, %2311] : memref<?x2100xf64>
        %2314 = affine.load %arg3[%2311] : memref<?xf64>
        %2315 = arith.mulf %2313, %2314 : f64
        %2316 = arith.addf %2312, %2315 : f64
        affine.store %2316, %arg5[%arg6] : memref<?xf64>
        %2317 = affine.apply #map6(%2281)
        %2318 = affine.load %arg5[%arg6] : memref<?xf64>
        %2319 = affine.load %arg2[%arg6, %2317] : memref<?x2100xf64>
        %2320 = affine.load %arg3[%2317] : memref<?xf64>
        %2321 = arith.mulf %2319, %2320 : f64
        %2322 = arith.addf %2318, %2321 : f64
        affine.store %2322, %arg5[%arg6] : memref<?xf64>
        %2323 = affine.apply #map7(%2281)
        %2324 = affine.load %arg5[%arg6] : memref<?xf64>
        %2325 = affine.load %arg2[%arg6, %2323] : memref<?x2100xf64>
        %2326 = affine.load %arg3[%2323] : memref<?xf64>
        %2327 = arith.mulf %2325, %2326 : f64
        %2328 = arith.addf %2324, %2327 : f64
        affine.store %2328, %arg5[%arg6] : memref<?xf64>
        %2329 = affine.apply #map8(%2281)
        %2330 = affine.load %arg5[%arg6] : memref<?xf64>
        %2331 = affine.load %arg2[%arg6, %2329] : memref<?x2100xf64>
        %2332 = affine.load %arg3[%2329] : memref<?xf64>
        %2333 = arith.mulf %2331, %2332 : f64
        %2334 = arith.addf %2330, %2333 : f64
        affine.store %2334, %arg5[%arg6] : memref<?xf64>
        %2335 = affine.apply #map9(%2281)
        %2336 = affine.load %arg5[%arg6] : memref<?xf64>
        %2337 = affine.load %arg2[%arg6, %2335] : memref<?x2100xf64>
        %2338 = affine.load %arg3[%2335] : memref<?xf64>
        %2339 = arith.mulf %2337, %2338 : f64
        %2340 = arith.addf %2336, %2339 : f64
        affine.store %2340, %arg5[%arg6] : memref<?xf64>
        %2341 = affine.apply #map10(%2281)
        %2342 = affine.load %arg5[%arg6] : memref<?xf64>
        %2343 = affine.load %arg2[%arg6, %2341] : memref<?x2100xf64>
        %2344 = affine.load %arg3[%2341] : memref<?xf64>
        %2345 = arith.mulf %2343, %2344 : f64
        %2346 = arith.addf %2342, %2345 : f64
        affine.store %2346, %arg5[%arg6] : memref<?xf64>
        %2347 = affine.apply #map11(%2281)
        %2348 = affine.load %arg5[%arg6] : memref<?xf64>
        %2349 = affine.load %arg2[%arg6, %2347] : memref<?x2100xf64>
        %2350 = affine.load %arg3[%2347] : memref<?xf64>
        %2351 = arith.mulf %2349, %2350 : f64
        %2352 = arith.addf %2348, %2351 : f64
        affine.store %2352, %arg5[%arg6] : memref<?xf64>
        %2353 = affine.apply #map12(%2281)
        %2354 = affine.load %arg5[%arg6] : memref<?xf64>
        %2355 = affine.load %arg2[%arg6, %2353] : memref<?x2100xf64>
        %2356 = affine.load %arg3[%2353] : memref<?xf64>
        %2357 = arith.mulf %2355, %2356 : f64
        %2358 = arith.addf %2354, %2357 : f64
        affine.store %2358, %arg5[%arg6] : memref<?xf64>
        %2359 = affine.apply #map13(%2281)
        %2360 = affine.load %arg5[%arg6] : memref<?xf64>
        %2361 = affine.load %arg2[%arg6, %2359] : memref<?x2100xf64>
        %2362 = affine.load %arg3[%2359] : memref<?xf64>
        %2363 = arith.mulf %2361, %2362 : f64
        %2364 = arith.addf %2360, %2363 : f64
        affine.store %2364, %arg5[%arg6] : memref<?xf64>
        %2365 = affine.apply #map14(%2281)
        %2366 = affine.load %arg5[%arg6] : memref<?xf64>
        %2367 = affine.load %arg2[%arg6, %2365] : memref<?x2100xf64>
        %2368 = affine.load %arg3[%2365] : memref<?xf64>
        %2369 = arith.mulf %2367, %2368 : f64
        %2370 = arith.addf %2366, %2369 : f64
        affine.store %2370, %arg5[%arg6] : memref<?xf64>
        %2371 = affine.apply #map15(%2281)
        %2372 = affine.load %arg5[%arg6] : memref<?xf64>
        %2373 = affine.load %arg2[%arg6, %2371] : memref<?x2100xf64>
        %2374 = affine.load %arg3[%2371] : memref<?xf64>
        %2375 = arith.mulf %2373, %2374 : f64
        %2376 = arith.addf %2372, %2375 : f64
        affine.store %2376, %arg5[%arg6] : memref<?xf64>
        %2377 = affine.apply #map16(%2281)
        %2378 = affine.load %arg5[%arg6] : memref<?xf64>
        %2379 = affine.load %arg2[%arg6, %2377] : memref<?x2100xf64>
        %2380 = affine.load %arg3[%2377] : memref<?xf64>
        %2381 = arith.mulf %2379, %2380 : f64
        %2382 = arith.addf %2378, %2381 : f64
        affine.store %2382, %arg5[%arg6] : memref<?xf64>
        %2383 = affine.apply #map17(%2281)
        %2384 = affine.load %arg5[%arg6] : memref<?xf64>
        %2385 = affine.load %arg2[%arg6, %2383] : memref<?x2100xf64>
        %2386 = affine.load %arg3[%2383] : memref<?xf64>
        %2387 = arith.mulf %2385, %2386 : f64
        %2388 = arith.addf %2384, %2387 : f64
        affine.store %2388, %arg5[%arg6] : memref<?xf64>
        %2389 = affine.apply #map18(%2281)
        %2390 = affine.load %arg5[%arg6] : memref<?xf64>
        %2391 = affine.load %arg2[%arg6, %2389] : memref<?x2100xf64>
        %2392 = affine.load %arg3[%2389] : memref<?xf64>
        %2393 = arith.mulf %2391, %2392 : f64
        %2394 = arith.addf %2390, %2393 : f64
        affine.store %2394, %arg5[%arg6] : memref<?xf64>
        %2395 = affine.apply #map19(%2281)
        %2396 = affine.load %arg5[%arg6] : memref<?xf64>
        %2397 = affine.load %arg2[%arg6, %2395] : memref<?x2100xf64>
        %2398 = affine.load %arg3[%2395] : memref<?xf64>
        %2399 = arith.mulf %2397, %2398 : f64
        %2400 = arith.addf %2396, %2399 : f64
        affine.store %2400, %arg5[%arg6] : memref<?xf64>
      }
      ...
      affine.for %arg7 = 0 to #map()[%0] step 400 {
        ...
        %2281 = affine.apply #map38(%arg7)
        %2282 = affine.load %arg4[%2281] : memref<?xf64>
        %2283 = affine.load %arg2[%arg6, %2281] : memref<?x2100xf64>
        %2284 = affine.load %arg5[%arg6] : memref<?xf64>
        %2285 = arith.mulf %2283, %2284 : f64
        %2286 = arith.addf %2282, %2285 : f64
        affine.store %2286, %arg4[%2281] : memref<?xf64>
        %2287 = affine.apply #map1(%2281)
        %2288 = affine.load %arg4[%2287] : memref<?xf64>
        %2289 = affine.load %arg2[%arg6, %2287] : memref<?x2100xf64>
        %2290 = affine.load %arg5[%arg6] : memref<?xf64>
        %2291 = arith.mulf %2289, %2290 : f64
        %2292 = arith.addf %2288, %2291 : f64
        affine.store %2292, %arg4[%2287] : memref<?xf64>
        %2293 = affine.apply #map2(%2281)
        %2294 = affine.load %arg4[%2293] : memref<?xf64>
        %2295 = affine.load %arg2[%arg6, %2293] : memref<?x2100xf64>
        %2296 = affine.load %arg5[%arg6] : memref<?xf64>
        %2297 = arith.mulf %2295, %2296 : f64
        %2298 = arith.addf %2294, %2297 : f64
        affine.store %2298, %arg4[%2293] : memref<?xf64>
        %2299 = affine.apply #map3(%2281)
        %2300 = affine.load %arg4[%2299] : memref<?xf64>
        %2301 = affine.load %arg2[%arg6, %2299] : memref<?x2100xf64>
        %2302 = affine.load %arg5[%arg6] : memref<?xf64>
        %2303 = arith.mulf %2301, %2302 : f64
        %2304 = arith.addf %2300, %2303 : f64
        affine.store %2304, %arg4[%2299] : memref<?xf64>
        %2305 = affine.apply #map4(%2281)
        %2306 = affine.load %arg4[%2305] : memref<?xf64>
        %2307 = affine.load %arg2[%arg6, %2305] : memref<?x2100xf64>
        %2308 = affine.load %arg5[%arg6] : memref<?xf64>
        %2309 = arith.mulf %2307, %2308 : f64
        %2310 = arith.addf %2306, %2309 : f64
        affine.store %2310, %arg4[%2305] : memref<?xf64>
        %2311 = affine.apply #map5(%2281)
        %2312 = affine.load %arg4[%2311] : memref<?xf64>
        %2313 = affine.load %arg2[%arg6, %2311] : memref<?x2100xf64>
        %2314 = affine.load %arg5[%arg6] : memref<?xf64>
        %2315 = arith.mulf %2313, %2314 : f64
        %2316 = arith.addf %2312, %2315 : f64
        affine.store %2316, %arg4[%2311] : memref<?xf64>
        %2317 = affine.apply #map6(%2281)
        %2318 = affine.load %arg4[%2317] : memref<?xf64>
        %2319 = affine.load %arg2[%arg6, %2317] : memref<?x2100xf64>
        %2320 = affine.load %arg5[%arg6] : memref<?xf64>
        %2321 = arith.mulf %2319, %2320 : f64
        %2322 = arith.addf %2318, %2321 : f64
        affine.store %2322, %arg4[%2317] : memref<?xf64>
        %2323 = affine.apply #map7(%2281)
        %2324 = affine.load %arg4[%2323] : memref<?xf64>
        %2325 = affine.load %arg2[%arg6, %2323] : memref<?x2100xf64>
        %2326 = affine.load %arg5[%arg6] : memref<?xf64>
        %2327 = arith.mulf %2325, %2326 : f64
        %2328 = arith.addf %2324, %2327 : f64
        affine.store %2328, %arg4[%2323] : memref<?xf64>
        %2329 = affine.apply #map8(%2281)
        %2330 = affine.load %arg4[%2329] : memref<?xf64>
        %2331 = affine.load %arg2[%arg6, %2329] : memref<?x2100xf64>
        %2332 = affine.load %arg5[%arg6] : memref<?xf64>
        %2333 = arith.mulf %2331, %2332 : f64
        %2334 = arith.addf %2330, %2333 : f64
        affine.store %2334, %arg4[%2329] : memref<?xf64>
        %2335 = affine.apply #map9(%2281)
        %2336 = affine.load %arg4[%2335] : memref<?xf64>
        %2337 = affine.load %arg2[%arg6, %2335] : memref<?x2100xf64>
        %2338 = affine.load %arg5[%arg6] : memref<?xf64>
        %2339 = arith.mulf %2337, %2338 : f64
        %2340 = arith.addf %2336, %2339 : f64
        affine.store %2340, %arg4[%2335] : memref<?xf64>
        %2341 = affine.apply #map10(%2281)
        %2342 = affine.load %arg4[%2341] : memref<?xf64>
        %2343 = affine.load %arg2[%arg6, %2341] : memref<?x2100xf64>
        %2344 = affine.load %arg5[%arg6] : memref<?xf64>
        %2345 = arith.mulf %2343, %2344 : f64
        %2346 = arith.addf %2342, %2345 : f64
        affine.store %2346, %arg4[%2341] : memref<?xf64>
        %2347 = affine.apply #map11(%2281)
        %2348 = affine.load %arg4[%2347] : memref<?xf64>
        %2349 = affine.load %arg2[%arg6, %2347] : memref<?x2100xf64>
        %2350 = affine.load %arg5[%arg6] : memref<?xf64>
        %2351 = arith.mulf %2349, %2350 : f64
        %2352 = arith.addf %2348, %2351 : f64
        affine.store %2352, %arg4[%2347] : memref<?xf64>
        %2353 = affine.apply #map12(%2281)
        %2354 = affine.load %arg4[%2353] : memref<?xf64>
        %2355 = affine.load %arg2[%arg6, %2353] : memref<?x2100xf64>
        %2356 = affine.load %arg5[%arg6] : memref<?xf64>
        %2357 = arith.mulf %2355, %2356 : f64
        %2358 = arith.addf %2354, %2357 : f64
        affine.store %2358, %arg4[%2353] : memref<?xf64>
        %2359 = affine.apply #map13(%2281)
        %2360 = affine.load %arg4[%2359] : memref<?xf64>
        %2361 = affine.load %arg2[%arg6, %2359] : memref<?x2100xf64>
        %2362 = affine.load %arg5[%arg6] : memref<?xf64>
        %2363 = arith.mulf %2361, %2362 : f64
        %2364 = arith.addf %2360, %2363 : f64
        affine.store %2364, %arg4[%2359] : memref<?xf64>
        %2365 = affine.apply #map14(%2281)
        %2366 = affine.load %arg4[%2365] : memref<?xf64>
        %2367 = affine.load %arg2[%arg6, %2365] : memref<?x2100xf64>
        %2368 = affine.load %arg5[%arg6] : memref<?xf64>
        %2369 = arith.mulf %2367, %2368 : f64
        %2370 = arith.addf %2366, %2369 : f64
        affine.store %2370, %arg4[%2365] : memref<?xf64>
        %2371 = affine.apply #map15(%2281)
        %2372 = affine.load %arg4[%2371] : memref<?xf64>
        %2373 = affine.load %arg2[%arg6, %2371] : memref<?x2100xf64>
        %2374 = affine.load %arg5[%arg6] : memref<?xf64>
        %2375 = arith.mulf %2373, %2374 : f64
        %2376 = arith.addf %2372, %2375 : f64
        affine.store %2376, %arg4[%2371] : memref<?xf64>
        %2377 = affine.apply #map16(%2281)
        %2378 = affine.load %arg4[%2377] : memref<?xf64>
        %2379 = affine.load %arg2[%arg6, %2377] : memref<?x2100xf64>
        %2380 = affine.load %arg5[%arg6] : memref<?xf64>
        %2381 = arith.mulf %2379, %2380 : f64
        %2382 = arith.addf %2378, %2381 : f64
        affine.store %2382, %arg4[%2377] : memref<?xf64>
        %2383 = affine.apply #map17(%2281)
        %2384 = affine.load %arg4[%2383] : memref<?xf64>
        %2385 = affine.load %arg2[%arg6, %2383] : memref<?x2100xf64>
        %2386 = affine.load %arg5[%arg6] : memref<?xf64>
        %2387 = arith.mulf %2385, %2386 : f64
        %2388 = arith.addf %2384, %2387 : f64
        affine.store %2388, %arg4[%2383] : memref<?xf64>
        %2389 = affine.apply #map18(%2281)
        %2390 = affine.load %arg4[%2389] : memref<?xf64>
        %2391 = affine.load %arg2[%arg6, %2389] : memref<?x2100xf64>
        %2392 = affine.load %arg5[%arg6] : memref<?xf64>
        %2393 = arith.mulf %2391, %2392 : f64
        %2394 = arith.addf %2390, %2393 : f64
        affine.store %2394, %arg4[%2389] : memref<?xf64>
        %2395 = affine.apply #map19(%2281)
        %2396 = affine.load %arg4[%2395] : memref<?xf64>
        %2397 = affine.load %arg2[%arg6, %2395] : memref<?x2100xf64>
        %2398 = affine.load %arg5[%arg6] : memref<?xf64>
        %2399 = arith.mulf %2397, %2398 : f64
        %2400 = arith.addf %2396, %2399 : f64
        affine.store %2400, %arg4[%2395] : memref<?xf64>
      }
      affine.for %arg7 = #map()[%0] to #map39()[%0] step 20 {
        %2 = affine.load %arg4[%arg7] : memref<?xf64>
        %3 = affine.load %arg2[%arg6, %arg7] : memref<?x2100xf64>
