...
#map3 = affine_map<()[s0] -> (((s0 - 2) floordiv 16) * 16 + 1)>
...
#map16 = affine_map<(d0) -> (d0 + 13)>
#map17 = affine_map<(d0) -> (d0 + 14)>
#map18 = affine_map<(d0) -> (d0 + 15)>
