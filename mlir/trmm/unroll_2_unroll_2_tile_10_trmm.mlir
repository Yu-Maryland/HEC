...
#map3 = affine_map<(d0)[s0] -> (d0 + (((-d0 + s0 - 1) floordiv 2) floordiv 2) * 4 + 1)>
#map4 = affine_map<(d0) -> (d0 + 2)>
#map5 = affine_map<(d0)[s0] -> (d0 + ((-d0 + s0 - 1) floordiv 2) * 2 + 1)>
#map6 = affine_map<(d0)[s0] -> (d0 + ((-d0 + s0 - 1) floordiv 2) * 2 + ((-d0 + s0 - ((-d0 + s0 - 1) floordiv 2) * 2 - 1) floordiv 2) * 2 + 1)>
      ...
      affine.for %arg6 = 0 to %0 step 10 {
        affine.for %arg7 = #map(%arg5) to min #map1(%arg5)[%1] {
          affine.for %arg8 = #map(%arg6) to min #map1(%arg6)[%0] {
            affine.for %arg9 = #map2(%arg7) to #map3(%arg7)[%1] step 4 {
            ...
            affine.for %arg9 = #map3(%arg7)[%1] to #map5(%arg7)[%1] step 2 {
              %4 = affine.load %arg3[%arg9, %arg7] : memref<?x1000xf64>
              %5 = affine.load %arg4[%arg9, %arg8] : memref<?x1200xf64>
              %6 = arith.mulf %4, %5 : f64
              %7 = affine.load %arg4[%arg7, %arg8] : memref<?x1200xf64>
            ...
            affine.for %arg9 = #map5(%arg7)[%1] to #map6(%arg7)[%1] step 2 {
              %4 = affine.load %arg3[%arg9, %arg7] : memref<?x1000xf64>
              %5 = affine.load %arg4[%arg9, %arg8] : memref<?x1200xf64>
              %6 = arith.mulf %4, %5 : f64
              %7 = affine.load %arg4[%arg7, %arg8] : memref<?x1200xf64>
            ...
            affine.for %arg9 = #map6(%arg7)[%1] to %1 {
              %4 = affine.load %arg3[%arg9, %arg7] : memref<?x1000xf64>
              %5 = affine.load %arg4[%arg9, %arg8] : memref<?x1200xf64>
              %6 = arith.mulf %4, %5 : f64
              %7 = affine.load %arg4[%arg7, %arg8] : memref<?x1200xf64>
