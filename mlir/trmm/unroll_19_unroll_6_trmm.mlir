...
#map1 = affine_map<(d0)[s0] -> (d0 + (((-d0 + s0 - 1) floordiv 6) floordiv 19) * 114 + 1)>
...
#map24 = affine_map<(d0)[s0] -> (d0 + ((-d0 + s0 - 1) floordiv 6) * 6 + 1)>
#map25 = affine_map<(d0)[s0] -> (d0 + ((-d0 + s0 - 1) floordiv 6) * 6 + ((-d0 + s0 - ((-d0 + s0 - 1) floordiv 6) * 6 - 1) floordiv 19) * 19 + 1)>
  ...
  func.func @kernel_trmm(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x1000xf64>, %arg4: memref<?x1200xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg5 = 0 to %1 {
      affine.for %arg6 = 0 to %0 {
        ...
        affine.for %arg7 = #map1(%arg5)[%1] to #map24(%arg5)[%1] step 6 {
          %4 = affine.load %arg3[%arg7, %arg5] : memref<?x1000xf64>
          %5 = affine.load %arg4[%arg7, %arg6] : memref<?x1200xf64>
          %6 = arith.mulf %4, %5 : f64
          %7 = affine.load %arg4[%arg5, %arg6] : memref<?x1200xf64>
        ...
        affine.for %arg7 = #map24(%arg5)[%1] to #map25(%arg5)[%1] step 19 {
          %4 = affine.load %arg3[%arg7, %arg5] : memref<?x1000xf64>
          %5 = affine.load %arg4[%arg7, %arg6] : memref<?x1200xf64>
          %6 = arith.mulf %4, %5 : f64
          %7 = affine.load %arg4[%arg5, %arg6] : memref<?x1200xf64>
