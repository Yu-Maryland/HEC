...
#map3 = affine_map<(d0)[s0] -> (d0 + (((-d0 + s0 - 1) floordiv 5) floordiv 11) * 55 + 1)>
...
#map18 = affine_map<(d0)[s0] -> (d0 + ((-d0 + s0 - 1) floordiv 5) * 5 + ((-d0 + s0 - ((-d0 + s0 - 1) floordiv 5) * 5 - 1) floordiv 11) * 11 + 1)>
      ...
      affine.for %arg6 = 0 to %0 step 10 {
        affine.for %arg7 = #map(%arg5) to min #map1(%arg5)[%1] {
          affine.for %arg8 = #map(%arg6) to min #map1(%arg6)[%0] {
            affine.for %arg9 = #map2(%arg7) to #map3(%arg7)[%1] step 55 {
            ...
            affine.for %arg9 = #map3(%arg7)[%1] to #map17(%arg7)[%1] step 5 {
              %4 = affine.load %arg3[%arg9, %arg7] : memref<?x1000xf64>
              %5 = affine.load %arg4[%arg9, %arg8] : memref<?x1200xf64>
              %6 = arith.mulf %4, %5 : f64
              %7 = affine.load %arg4[%arg7, %arg8] : memref<?x1200xf64>
            ...
            affine.for %arg9 = #map17(%arg7)[%1] to #map18(%arg7)[%1] step 11 {
              %4 = affine.load %arg3[%arg9, %arg7] : memref<?x1000xf64>
              %5 = affine.load %arg4[%arg9, %arg8] : memref<?x1200xf64>
              %6 = arith.mulf %4, %5 : f64
              %7 = affine.load %arg4[%arg7, %arg8] : memref<?x1200xf64>
            ...
            affine.for %arg9 = #map18(%arg7)[%1] to %1 {
              %4 = affine.load %arg3[%arg9, %arg7] : memref<?x1000xf64>
              %5 = affine.load %arg4[%arg9, %arg8] : memref<?x1200xf64>
              %6 = arith.mulf %4, %5 : f64
              %7 = affine.load %arg4[%arg7, %arg8] : memref<?x1200xf64>
