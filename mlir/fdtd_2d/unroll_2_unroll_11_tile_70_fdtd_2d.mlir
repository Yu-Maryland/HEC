...
#map2 = affine_map<()[s0] -> (((s0 floordiv 11) floordiv 2) * 22)>
...
#map15 = affine_map<()[s0] -> ((s0 floordiv 11) * 11 + ((s0 mod 11) floordiv 2) * 2)>
#map16 = affine_map<()[s0] -> ((((s0 - 1) floordiv 11) floordiv 2) * 22 + 1)>
#map17 = affine_map<()[s0] -> (((s0 - 1) floordiv 11) * 11 + 1)>
#map18 = affine_map<()[s0] -> (((s0 - 1) floordiv 11) * 11 + ((s0 - ((s0 - 1) floordiv 11) * 11 - 1) floordiv 2) * 2 + 1)>
#map19 = affine_map<()[s0] -> (s0 - 1)>
#map20 = affine_map<()[s0] -> ((((s0 - 1) floordiv 11) floordiv 2) * 22)>
#map21 = affine_map<()[s0] -> (((s0 - 1) floordiv 11) * 11)>
#map22 = affine_map<()[s0] -> (((s0 - 1) floordiv 11) * 11 + ((s0 - ((s0 - 1) floordiv 11) * 11 - 1) floordiv 2) * 2)>
  ...
  func.func @kernel_fdtd_2d(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<?x1200xf64>, %arg4: memref<?x1200xf64>, %arg5: memref<?x1200xf64>, %arg6: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg7 = 0 to %2 step 70 {
      affine.for %arg8 = #map(%arg7) to min #map1(%arg7)[%2] {
        ...
        affine.for %arg9 = #map2()[%1] to #map14()[%1] step 11 {
          %3 = affine.load %arg6[%arg8] : memref<?xf64>
          affine.store %3, %arg4[0, %arg9] : memref<?x1200xf64>
          %4 = affine.apply #map3(%arg9)
          %5 = affine.load %arg6[%arg8] : memref<?xf64>
        ...
        affine.for %arg9 = 1 to %0 {
          ...
          affine.for %arg10 = #map2()[%1] to #map14()[%1] step 11 {
            %3 = affine.load %arg4[%arg9, %arg10] : memref<?x1200xf64>
            %4 = affine.load %arg5[%arg9, %arg10] : memref<?x1200xf64>
            %5 = affine.load %arg5[%arg9 - 1, %arg10] : memref<?x1200xf64>
            %6 = arith.subf %4, %5 : f64
          ...
          affine.for %arg10 = #map14()[%1] to #map15()[%1] step 2 {
            %3 = affine.load %arg4[%arg9, %arg10] : memref<?x1200xf64>
            %4 = affine.load %arg5[%arg9, %arg10] : memref<?x1200xf64>
            %5 = affine.load %arg5[%arg9 - 1, %arg10] : memref<?x1200xf64>
            %6 = arith.subf %4, %5 : f64
        ...
        affine.for %arg9 = 0 to %0 {
          affine.for %arg10 = 1 to #map16()[%1] step 22 {
        ...
        affine.for %arg9 = 0 to #map19()[%0] {
          affine.for %arg10 = 0 to #map20()[%1] step 22 {
