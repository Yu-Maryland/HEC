...
#map28 = affine_map<()[s0] -> ((((s0 - 1) floordiv 13) floordiv 14) * 182 + 1)>
#map29 = affine_map<()[s0] -> (((s0 - 1) floordiv 13) * 13 + 1)>
#map30 = affine_map<()[s0] -> (((s0 - 1) floordiv 13) * 13 + ((s0 - ((s0 - 1) floordiv 13) * 13 - 1) floordiv 14) * 14 + 1)>
#map31 = affine_map<()[s0] -> (s0 - 1)>
#map32 = affine_map<()[s0] -> ((((s0 - 1) floordiv 13) floordiv 14) * 182)>
#map33 = affine_map<()[s0] -> (((s0 - 1) floordiv 13) * 13)>
#map34 = affine_map<()[s0] -> (((s0 - 1) floordiv 13) * 13 + ((s0 - ((s0 - 1) floordiv 13) * 13 - 1) floordiv 14) * 14)>
