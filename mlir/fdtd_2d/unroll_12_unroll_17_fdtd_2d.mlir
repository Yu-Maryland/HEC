...
#map30 = affine_map<()[s0] -> ((((s0 - 1) floordiv 17) floordiv 12) * 204 + 1)>
#map31 = affine_map<()[s0] -> (((s0 - 1) floordiv 17) * 17 + 1)>
#map32 = affine_map<()[s0] -> (((s0 - 1) floordiv 17) * 17 + ((s0 - ((s0 - 1) floordiv 17) * 17 - 1) floordiv 12) * 12 + 1)>
#map33 = affine_map<()[s0] -> (s0 - 1)>
#map34 = affine_map<()[s0] -> ((((s0 - 1) floordiv 17) floordiv 12) * 204)>
#map35 = affine_map<()[s0] -> (((s0 - 1) floordiv 17) * 17)>
#map36 = affine_map<()[s0] -> (((s0 - 1) floordiv 17) * 17 + ((s0 - ((s0 - 1) floordiv 17) * 17 - 1) floordiv 12) * 12)>
  ...
  func.func @kernel_fdtd_2d(%arg0: i32, %arg1: i32, %arg2: i32, %arg3: memref<?x1200xf64>, %arg4: memref<?x1200xf64>, %arg5: memref<?x1200xf64>, %arg6: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg7 = 0 to %2 {
      ...
      affine.for %arg8 = 0 to %0 {
        affine.for %arg9 = 1 to #map30()[%1] step 204 {
      ...
      affine.for %arg8 = 0 to #map33()[%0] {
        affine.for %arg9 = 0 to #map34()[%1] step 204 {
        ...
        affine.for %arg9 = #map35()[%1] to #map36()[%1] step 12 {
          %3 = affine.load %arg5[%arg8, %arg9] : memref<?x1200xf64>
          %4 = affine.load %arg3[%arg8, %arg9 + 1] : memref<?x1200xf64>
          %5 = affine.load %arg3[%arg8, %arg9] : memref<?x1200xf64>
          %6 = arith.subf %4, %5 : f64
