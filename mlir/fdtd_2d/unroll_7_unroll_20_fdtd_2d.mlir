...
#map28 = affine_map<()[s0] -> ((((s0 - 1) floordiv 20) floordiv 7) * 140 + 1)>
#map29 = affine_map<()[s0] -> (((s0 - 1) floordiv 20) * 20 + 1)>
#map30 = affine_map<()[s0] -> (((s0 - 1) floordiv 20) * 20 + ((s0 - ((s0 - 1) floordiv 20) * 20 - 1) floordiv 7) * 7 + 1)>
#map31 = affine_map<()[s0] -> (s0 - 1)>
#map32 = affine_map<()[s0] -> ((((s0 - 1) floordiv 20) floordiv 7) * 140)>
#map33 = affine_map<()[s0] -> (((s0 - 1) floordiv 20) * 20)>
#map34 = affine_map<()[s0] -> (((s0 - 1) floordiv 20) * 20 + ((s0 - ((s0 - 1) floordiv 20) * 20 - 1) floordiv 7) * 7)>
