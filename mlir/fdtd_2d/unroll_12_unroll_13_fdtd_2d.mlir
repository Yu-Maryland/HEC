...
#map26 = affine_map<()[s0] -> ((((s0 - 1) floordiv 13) floordiv 12) * 156 + 1)>
#map27 = affine_map<()[s0] -> (((s0 - 1) floordiv 13) * 13 + 1)>
#map28 = affine_map<()[s0] -> (((s0 - 1) floordiv 13) * 13 + ((s0 - ((s0 - 1) floordiv 13) * 13 - 1) floordiv 12) * 12 + 1)>
#map29 = affine_map<()[s0] -> (s0 - 1)>
#map30 = affine_map<()[s0] -> ((((s0 - 1) floordiv 13) floordiv 12) * 156)>
#map31 = affine_map<()[s0] -> (((s0 - 1) floordiv 13) * 13)>
#map32 = affine_map<()[s0] -> (((s0 - 1) floordiv 13) * 13 + ((s0 - ((s0 - 1) floordiv 13) * 13 - 1) floordiv 12) * 12)>
