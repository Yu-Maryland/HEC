...
#map1 = affine_map<(d0) -> (((d0 floordiv 18) floordiv 20) * 360)>
...
#map20 = affine_map<(d0) -> (d0 + 36)>
#map21 = affine_map<(d0) -> (d0 + 54)>
#map22 = affine_map<(d0) -> (d0 + 72)>
#map23 = affine_map<(d0) -> (d0 + 90)>
#map24 = affine_map<(d0) -> (d0 + 108)>
#map25 = affine_map<(d0) -> (d0 + 126)>
#map26 = affine_map<(d0) -> (d0 + 144)>
#map27 = affine_map<(d0) -> (d0 + 162)>
#map28 = affine_map<(d0) -> (d0 + 180)>
#map29 = affine_map<(d0) -> (d0 + 198)>
#map30 = affine_map<(d0) -> (d0 + 216)>
#map31 = affine_map<(d0) -> (d0 + 234)>
#map32 = affine_map<(d0) -> (d0 + 252)>
#map33 = affine_map<(d0) -> (d0 + 270)>
#map34 = affine_map<(d0) -> (d0 + 288)>
#map35 = affine_map<(d0) -> (d0 + 306)>
#map36 = affine_map<(d0) -> (d0 + 324)>
#map37 = affine_map<(d0) -> (d0 + 342)>
#map38 = affine_map<(d0) -> ((d0 floordiv 18) * 18)>
#map39 = affine_map<(d0) -> ((d0 floordiv 18) * 18 + ((d0 mod 18) floordiv 20) * 20)>
#map40 = affine_map<(d0) -> (d0 + 19)>
  ...
  func.func @kernel_lu(%arg0: i32, %arg1: memref<?x2000xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg2 = 0 to %0 {
      affine.for %arg3 = 0 to #map(%arg2) {
        ...
        affine.for %arg4 = #map1(%arg3) to #map38(%arg3) step 18 {
          %4 = affine.load %arg1[%arg2, %arg4] : memref<?x2000xf64>
          %5 = affine.load %arg1[%arg4, %arg3] : memref<?x2000xf64>
          %6 = arith.mulf %4, %5 : f64
          %7 = affine.load %arg1[%arg2, %arg3] : memref<?x2000xf64>
        ...
        affine.for %arg4 = #map38(%arg3) to #map39(%arg3) step 20 {
          %4 = affine.load %arg1[%arg2, %arg4] : memref<?x2000xf64>
          %5 = affine.load %arg1[%arg4, %arg3] : memref<?x2000xf64>
          %6 = arith.mulf %4, %5 : f64
          %7 = affine.load %arg1[%arg2, %arg3] : memref<?x2000xf64>
      ...
      affine.for %arg3 = #map(%arg2) to %0 {
        ...
        affine.for %arg4 = #map1(%arg2) to #map38(%arg2) step 18 {
          %1 = affine.load %arg1[%arg2, %arg4] : memref<?x2000xf64>
          %2 = affine.load %arg1[%arg4, %arg3] : memref<?x2000xf64>
          %3 = arith.mulf %1, %2 : f64
          %4 = affine.load %arg1[%arg2, %arg3] : memref<?x2000xf64>
        ...
        affine.for %arg4 = #map38(%arg2) to #map39(%arg2) step 20 {
          %1 = affine.load %arg1[%arg2, %arg4] : memref<?x2000xf64>
          %2 = affine.load %arg1[%arg4, %arg3] : memref<?x2000xf64>
          %3 = arith.mulf %1, %2 : f64
          %4 = affine.load %arg1[%arg2, %arg3] : memref<?x2000xf64>
