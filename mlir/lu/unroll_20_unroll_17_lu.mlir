...
#map1 = affine_map<(d0) -> (((d0 floordiv 17) floordiv 20) * 340)>
...
#map26 = affine_map<(d0) -> (d0 + 153)>
#map27 = affine_map<(d0) -> (d0 + 170)>
#map28 = affine_map<(d0) -> (d0 + 187)>
#map29 = affine_map<(d0) -> (d0 + 204)>
#map30 = affine_map<(d0) -> (d0 + 221)>
#map31 = affine_map<(d0) -> (d0 + 238)>
#map32 = affine_map<(d0) -> (d0 + 255)>
#map33 = affine_map<(d0) -> (d0 + 272)>
#map34 = affine_map<(d0) -> (d0 + 289)>
#map35 = affine_map<(d0) -> (d0 + 306)>
#map36 = affine_map<(d0) -> (d0 + 323)>
#map37 = affine_map<(d0) -> ((d0 floordiv 17) * 17)>
#map38 = affine_map<(d0) -> ((d0 floordiv 17) * 17 + ((d0 mod 17) floordiv 20) * 20)>
#map39 = affine_map<(d0) -> (d0 + 18)>
  ...
  func.func @kernel_lu(%arg0: i32, %arg1: memref<?x2000xf64>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    affine.for %arg2 = 0 to %0 {
      affine.for %arg3 = 0 to #map(%arg2) {
        affine.for %arg4 = 0 to #map1(%arg3) step 340 {
        ...
        affine.for %arg4 = #map1(%arg3) to #map37(%arg3) step 17 {
          %4 = affine.load %arg1[%arg2, %arg4] : memref<?x2000xf64>
          %5 = affine.load %arg1[%arg4, %arg3] : memref<?x2000xf64>
          %6 = arith.mulf %4, %5 : f64
          %7 = affine.load %arg1[%arg2, %arg3] : memref<?x2000xf64>
        ...
        affine.for %arg4 = #map37(%arg3) to #map38(%arg3) step 20 {
          %4 = affine.load %arg1[%arg2, %arg4] : memref<?x2000xf64>
          %5 = affine.load %arg1[%arg4, %arg3] : memref<?x2000xf64>
          %6 = arith.mulf %4, %5 : f64
          %7 = affine.load %arg1[%arg2, %arg3] : memref<?x2000xf64>
      ...
      affine.for %arg3 = #map(%arg2) to %0 {
        affine.for %arg4 = 0 to #map1(%arg2) step 340 {
        ...
        affine.for %arg4 = #map1(%arg2) to #map37(%arg2) step 17 {
          %1 = affine.load %arg1[%arg2, %arg4] : memref<?x2000xf64>
          %2 = affine.load %arg1[%arg4, %arg3] : memref<?x2000xf64>
          %3 = arith.mulf %1, %2 : f64
          %4 = affine.load %arg1[%arg2, %arg3] : memref<?x2000xf64>
        ...
        affine.for %arg4 = #map37(%arg2) to #map38(%arg2) step 20 {
          %1 = affine.load %arg1[%arg2, %arg4] : memref<?x2000xf64>
          %2 = affine.load %arg1[%arg4, %arg3] : memref<?x2000xf64>
          %3 = arith.mulf %1, %2 : f64
          %4 = affine.load %arg1[%arg2, %arg3] : memref<?x2000xf64>
